...
*/
Seriously.plugin('mixer', (function () {
	var modes = {
		'normal': 'BlendNormal',
...
//				'#define BlendOpacity(base, blend, F, O, A)	            ((F(base.rgb * blend.a * O, blend.rgb * blend.a * O) + base.rgb * base.a * (1.0 - blend.a * O)) / A)\n' +
				'#define BlendOpacity(base, blend, F, OBase, OBlend, A)	((F(base.rgb * blend.a * OBase, blend.rgb * blend.a * OBlend) + (base.rgb * base.a * OBase) * (1.0 - blend.a * OBlend)) / A)\n' +
//				'#define BlendOpacity(base, blend, F, OBase, OBlend, A)	(( F(base.rgb * OBase, blend.rgb * OBlend) ))\n' +
				'\n' +
...
//				'	float alpha = 1.0 - (1.0 - topPixel.a) * (1.0 - bottomPixel.a);\n' +
				...
				'		color = vec3(0.0);\n' +
				'	} else {\n' +
				'		color = BlendOpacity(bottomPixel, topPixel, BlendFunction, opacityBottom, opacityTop, alpha);\n' +
				'	}\n' +
